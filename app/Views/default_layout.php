...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url('/public/assets/css/main.css')?>?<?= APP_VARSION ?>">
...
<body class="d-flex flex-column h-100">
    ...
    <script src="<?=base_url('/public/assets/js/clock.js')?>?<?= APP_VARSION ?>" crossorigin="anonymous"></script>
</body>
